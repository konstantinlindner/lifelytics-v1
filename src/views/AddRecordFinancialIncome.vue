  ...
  <div class="px-4 py-4 mx-auto flex flex-col">
    ...
    <div class="mx-auto max-w-max">
      <div class="border min-w-max p-4 rounded-md">
        <h1 class="text-xl mb-6 flex justify-center">Income</h1>

        <div
          ref="optionSelector"
          class="min-w-max grid gap-4 grid-cols-3 rounded-md"
        >
          <router-link :to="{ name: 'AddRecordFinancialDetails' }">
            <button
            ...
            >
              ...
              <Icon class="mx-auto" icon="mdi:cash-100" width="80" />
          ...
          <router-link :to="{ name: 'AddRecordFinancialDetails' }">
            ...
            >
              ...
              <h1 class="mx-2">Realized investments</h1>
            </button>
          </router-link>
          ...
          <router-link :to="{ name: 'AddRecordFinancialDetails' }">
            ...
            >
              ...
              <Icon class="mx-auto" icon="mdi:robber" width="80" />
              <h1 class="mx-2">Other income</h1>
            </button>
          </router-link>
        </div>
      </div>
